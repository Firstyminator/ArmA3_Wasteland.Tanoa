...
while {true} do
{
...

	{
		...
		_message =  format ["Your team received a $%1 bonus for holding %2 tow%3 during the past %4 minutes", [_money] call fn_numbersText, _count, if (_count == 1) then { "n" } else { "ns" }, ceil (_timeInterval / 60)];
