...
#define ITEM_CONDITION "{cursortarget iskindof 'Land_Laptop_unfolded_F'} && {alive cursorTarget} && {(player distance cursortarget) < 5}"
...
BoS_open = 
{
	...
	_objects = nearestObjects [player, ["Land_Laptop_unfolded_F"], 5];
