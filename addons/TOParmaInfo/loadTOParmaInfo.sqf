...
_generalInfoString = "Website: <t color='#0091CD'><a href='https://www.noelite.no'>www.noelite.no</a></t> Forum: <t color='#0091CD'><a href='https://www.noelite.no'>www.noelite.no/forum</a></t> Facebook: NoEliteGaming";
