...
_timeout = 8;
{
	...
	_titleText = format[("<t font='PuristaSemiBold' size='1.10' color='#FFFFFF ' align='left' shadow='1' shadowColor='#000000'>%1</t><br /><t shadow='1'shadowColor='#000000' font='PuristaSemiBold' size='1.70' color='#FFFFFF' align='left'>%2</t>"), _title, _content];
